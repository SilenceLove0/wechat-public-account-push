export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxefb55a2ba1b1a6f0",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "1335625bd3da98635316322f09e35533",
  ...
  USERS: [
    {
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "Zoe", "year": "2000", "date": "09-22"},
     
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {"type": "生日", "name": "Silence", "year": "2001", "date": "03-31"},
        {"type": "节日", "name": "在一起的日子", "year": "2022", "date": "01-05"},
      ],
